...
import {getAuth,signInWithEmailAndPassword,doc} from './Firebase';
...
function Signin ({navigation}){
    ...
    return (
      ...
      >
        <RadioButtonItem value="test2" label="Manager"/>
        ...
        <TouchableHighlight style={[styles.buttonContainer, styles.signupButton]} onPress={Login}>
